...
import com.ys.admin.base.interceptors.TokenFilter;
import com.ys.admin.base.shiroRealm.CustomAuthenticationFilter;
import com.ys.admin.base.shiroRealm.CustomSubjectFactory;
import com.ys.admin.base.shiroRealm.ShiroDbRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter() {
		...
		bean.setFilterChainDefinitions("" +
				"/#/** = anon\n" +
				"/community/queryDefaultCommunityId** = anon\n" +
				"/error** = anon\n" +
				"/swagger** = anon\n" +
				"/webjars/** = anon\n" +
				"/v2/** = anon\n" +
