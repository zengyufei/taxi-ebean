...
const {
    mockUtils: { init, add, update, del, queryById, queryPage, queryByIds, reload, queryList },
} = require('../utils/index.jsx')

const prefix = 'car'
const queryPageOption = ['account', 'mobile', 'roleId', 'locked', 'initPwd', 'available', 'realName', 'orgNo']
const timeOut = 1000

const queryPageUrl = `GET /${prefix}/queryPage`
const queryByIdUrl = `GET /${prefix}/queryById`
const queryByIdsUrl = `GET /${prefix}/queryByIds`
const insertUrl = `POST /${prefix}/insert`
const deleteByIdUrl = `GET /${prefix}/removeById`
const updateUrl = `POST /${prefix}/update`
const updateNotNullUrl = `POST /${prefix}/update`
const reloadUrl = `GET /${prefix}/reload`
    ...
    'result|100': [
        {
            ...
            'carType|+1': ['BYD_E6', 'BYD_E5', 'BM_EU220'],
