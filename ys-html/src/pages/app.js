 ...
 * @Last Modified time: 2017-09-06 15:24:36
 */
...
const App = option => {
  ...
  return (
    <div>
      ...
      <div className={classnames(styles.layout, { [styles.fold]: isSmall ? false : siderFold }, { [styles.withnavbar]: isSmall })}>
        {
          !isSmall ? <aside className={classnames(styles.sider, { [styles.light]: true })}>
            <Sider {...siderProps} />
          </aside> : ''
        }
        <div className={styles.main}>
          ...
          <div className={styles.container}>
            {
              !isSysModule && !!allCommunity.length && <div className={styles.tree}>
                <CommunityTree />
              </div>
            }
            <div className={styles.content}>
              <div style={{ width: 1475 }}>
                {children}
              </div>
            </div>
          </div>
