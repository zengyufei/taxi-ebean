...
const defaultSearchFields = ['name', 'equNo', 'equEnum', 'ip', 'mac', 'password', 'onlineEnum', 'times', 'keenNumb', 'communityId', 'buildingId', 'unitId', 'roomId']
...
// 表格
const defaultTableFields = ['name', 'equNo', 'equEnum', 'ip', 'mac', 'password', 'onlineEnum', 'times', 'keenNumb', 'communityId', 'buildingId', 'unitId', 'roomId']
