...
const List = options => {
    ...
    const { handlerUpload, toExport, openAddPage, openUpdatePage, onShowSizeChange, onChange, handlerDelete } = methods
    ...
    const importCar = {
        name: 'file',
        action: `${BASE_URL}/${prefix}/import`,
        headers: {
            token: session.get(constant.tokenSessionKey),
        },
