    ...
    return (
        <div>
            <div style={headerStyle}>
                <span style={headerTitleStyle}>智慧社区</span>
            </div>
            <div style={style}>
                <TweenOneGroup key="b">
                    <Form onSubmit={handleSubmit} style={formStyle}>
                        <Card title="登录">
                            <ZFormItem
                                {...itemProps}
                                field={fieldMap.account}
                                inputProps={{ prefix: <Icon type="user" style={{ fontSize: 13 }}/> }}
                                placeholder="账户"
                            />
                            <ZFormItem
                                {...itemProps}
                                field={fieldMap.password}
                                inputProps={{ prefix: <Icon type="lock" style={{ fontSize: 13 }}/> }}
                                placeholder="密码"
                            />
