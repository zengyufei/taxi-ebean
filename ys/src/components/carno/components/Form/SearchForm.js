    ...
    <Form layout="inline">
      <Row>
        {fields.map((field, index) => {
          ...
          const labelCol = (isSmall && { span: 24 }) || finalFormItemLayout.labelCol || { span: showLabel ? 7 : 0 }
          const wrapperCol = (isSmall && { span: 24 }) || finalFormItemLayout.wrapperCol || { span: showLabel ? 16 : 24 }
          return (<Col {...itemCol} key={`itemKey_${field.key}`}>
